...
Por esta razón, este proyecto busca analizar el proceso actual y plantear una alternativa utilizando Databricks y una arquitectura de datos que permita automatizar buena parte de estas actividades.
La idea es tomar como punto de partida el archivo original descargado desde SAP, realizar dentro de Databricks las transformaciones que actualmente se hacen en Excel y generar una información final que pueda ser utilizada nuevamente en Power BI.
Como complemento, se analizará la posibilidad de utilizar Machine Learning para encontrar patrones dentro de los datos de producción y determinar qué variables tienen mayor relación con el comportamiento de los indicadores.
Con esto se busca no solamente automatizar un proceso, sino también demostrar cómo los datos que actualmente se utilizan para generar reportes pueden aprovecharse para obtener información adicional que apoye el análisis de la operación.
...
<img width="1521" height="770" alt="Bigdata 2" src="https://github.com/user-attachments/assets/37967fd0-abe4-408b-a09a-5adaea69ed5b" />
